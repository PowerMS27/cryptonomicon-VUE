      ...
      <section>
        ...
        <div>
          <input
            ...
            @input="page = 1"
            type="text"
            class="block shadow-md pr-10 border-gray-300 text-gray-900 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm rounded-md"
            placeholder="Поиск: "
          />
          <button
            @click="page -= 1"
